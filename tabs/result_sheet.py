...
def view_result_sheet(db_manager):
    ...
    with col1:
        ...
        if income_statement_data['products']:
            ...
            products_data.append({
                ...
                t('amount_column'): f"CHF {income_statement_data['total_products']:,.2f}"
            })
    ...
    with col2:
        ...
        if income_statement_data['expenses']:
            ...
            expenses_data.append({
                ...
                t('amount_column'): f"CHF {income_statement_data['total_expenses']:,.2f}"
            })
    ...
    with col1:
        st.metric(t('total_products'), f"CHF {income_statement_data['total_products']:,.2f}")
    
    with col2:
        st.metric(t('total_expenses'), f"CHF {income_statement_data['total_expenses']:,.2f}")
